...
int next_frame_duration(encoding_context *context) {
...
void argb_to_vpximage(int *argb, vpx_image_t vpx_image, int width, int height) {
...
int encode_argb_frame(encoding_context *context, int *argb) {
